...
| — | [Architecture roadmap](architecture-roadmap.md) · [Rate-limiting migration](rate-limiting-migration.md) · [Architecture (HTML)](ARCHITECTURE.html) | Detailed plans |
| — | [Gaps](GAPS.md) | Ranked open issues |
| — | [PRD](PRD.md) · [Roadmap](ROADMAP.md) · [MENA positioning](mena-positioning.md) · [Impact analysis](IMPACT_ANALYSIS.md) | Product planning |
